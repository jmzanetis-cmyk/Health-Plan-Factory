      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-sm font-light" style={{ color: "var(--text-secondary)", fontFamily: "var(--app-font-sans)" }}>
            Sign in to your HealthPlanFactory account
          </p>
        </div>
          ...
          <div className="flex flex-col gap-4 mb-6">
            <div>
              ...
              <input
                ...
                style={{ border: "1px solid rgba(27,45,79,0.15)", background: "var(--warm-white)", color: "var(--navy)", fontFamily: "var(--app-font-sans)" }}
              />
            </div>
            <div>
